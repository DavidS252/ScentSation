...
data class Post(
    ...
    companion object {
        ...
        const val FRAGRANCE_BRAND_KEY = "fragranceBrand"
        ...
        fun fromJSON(json: Map<String, Any>): Post {
            ...
            val fragranceBrand = json[FRAGRANCE_BRAND_KEY] as? String ?: ""
            ...
            val post = Post(id, fragranceName, fragranceBrand, fragranceRating, userId, description, isDeleted,
                aromas)
            return post
        }
    }
    ...
    val json: Map<String, Any>
        get() {
            return hashMapOf(
                ...
                FRAGRANCE_BRAND_KEY to fragranceBrand,
